...
, Debug__Counter( &slot->parts[part_Debug__Counter] )
...
{
    Counter.instantiate( NULL, slot->parts[Capsule_Debug__Top::part_Debug__Counter].slots[0], UMLRTFrameService::createBorderPorts( slot->parts[Capsule_Debug__Top::part_Debug__Counter].slots[0], Counter.numPortRolesBorder ) );
