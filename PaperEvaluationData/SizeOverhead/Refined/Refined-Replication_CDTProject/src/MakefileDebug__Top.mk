...
UMLRTS_ROOT ?= /Users/mojtababagherzadeh/rts
...
SRCS = Debug__TopMain.cc Configuration.cc ExtInterface.cc Config.cc ENV.cc Server.cc Client.cc FailOver.cc HostInfo.cc Host.cc Services.cc ServerInfo.cc Echo.cc EchoCapsule.cc Simulator.cc GateWay.cc Debug__Top.cc Debug__TopControllers.cc 
OBJS = $(subst $(CC_EXT),$(OBJ_EXT),$(SRCS))

MAIN = Debug__TopMain$(EXE_EXT)
