...
private:
    enum State
    {
        Debug__C__IDLE__IDLE__1,
        Debug__C__Initial,
        Debug__C__IDLE__IDLE__1__Debug__A__Ac__IDLE__IDLE__1,
        Debug__C__IDLE__IDLE__1__Debug__A__En__IDLE,
        Debug__C__IDLE__IDLE__1__Debug__B__Ac__IDLE__IDLE__1,
        Debug__C__IDLE__IDLE__1__Debug__B__Ex__IDLE,
        Debug__C__IDLE__IDLE__1__boundary,
    ...
    void entryaction_____Debug__C__IDLE__IDLE__1__Debug__A__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    void entryaction_____Debug__C__IDLE__IDLE__1__Debug__A__En__IDLE( const UMLRTMessage * msg );
    void entryaction_____Debug__C__IDLE__IDLE__1__Debug__B__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    void entryaction_____Debug__C__IDLE__IDLE__1__Debug__B__Ex__IDLE( const UMLRTMessage * msg );
    void entryaction_____Debug__C__IDLE__IDLE__1__boundary( const UMLRTMessage * msg );
    ...
    void exitaction_____Debug__C__IDLE__IDLE__1__Debug__A__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    void exitaction_____Debug__C__IDLE__IDLE__1__Debug__A__En__IDLE( const UMLRTMessage * msg );
    void exitaction_____Debug__C__IDLE__IDLE__1__Debug__B__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    void exitaction_____Debug__C__IDLE__IDLE__1__Debug__B__Ex__IDLE( const UMLRTMessage * msg );
    void exitaction_____Debug__C__IDLE__IDLE__1__boundary( const UMLRTMessage * msg );
    ...
    void transitionaction_____Debug__C__IDLE__IDLE__1__Debug__AC__IDLE__IDLE__1( const UMLRTMessage * msg );
    void transitionaction_____Debug__C__IDLE__IDLE__1__Debug__En__IDLE( const UMLRTMessage * msg );
    void transitionaction_____Debug__C__IDLE__IDLE__1__Debug__Ex__IDLE( const UMLRTMessage * msg );
    void transitionaction_____Debug__C__IDLE__IDLE__1__Debug__end__trans__IDLE__IDLE__1( const UMLRTMessage * msg );
    void transitionaction_____Debug__C__IDLE__IDLE__1__Debug__init__trans__IDLE__IDLE__1( const UMLRTMessage * msg );
    ...
    void transitionaction_____Debug__IDLE__IDLE__1( const UMLRTMessage * msg );
    void transitionaction_____Debug__IDLE__IDLE__1__E( const UMLRTMessage * msg );
    void transitionaction_____Debug__IDLE__IDLE__1__S( const UMLRTMessage * msg );
    void transitionaction_____Debug__IDLE__IDLE__1__dbg( const UMLRTMessage * msg );
    ...
    void transitionaction_____IDLE__IDLE__1( const UMLRTMessage * msg );
    void transitionaction_____Initial( const UMLRTMessage * msg );
    bool action_____Debug__IDLE__IDLE__1__S__Debug__GuardIDLE__IDLE__1( const UMLRTMessage * msg );
    bool action_____Debug__Initial__S__Debug__GuardInitial( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__Debug__AC__IDLE__IDLE__1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__Debug__En__IDLE( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__Debug__Ex__IDLE( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__Debug__end__trans__IDLE__IDLE__1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__Debug__init__trans__IDLE__IDLE__1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_10( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_2( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_3( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_4( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_5_to_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_6( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_7( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_8( const UMLRTMessage * msg );
    void actionchain_____Debug__C__IDLE__IDLE__1__new_transition_9( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__IDLE__IDLE__1( const UMLRTMessage * msg );
    void actionchain_____Debug__IDLE__IDLE__1__E( const UMLRTMessage * msg );
    void actionchain_____Debug__IDLE__IDLE__1__S( const UMLRTMessage * msg );
    void actionchain_____Debug__IDLE__IDLE__1__dbg( const UMLRTMessage * msg );
    ...
    void actionchain_____IDLE__IDLE__1( const UMLRTMessage * msg );
    void actionchain_____Initial( const UMLRTMessage * msg );
    State junction_____Debug__C__IDLE__IDLE__1__en( const UMLRTMessage * msg );
    State junction_____Debug__C__IDLE__IDLE__1__ex( const UMLRTMessage * msg );
    State junction_____Debug__C__IDLE__IDLE__1__new_exitpoint_1( const UMLRTMessage * msg );
    ...
    State choice_____Debug__C__IDLE__IDLE__1__deephistory( const UMLRTMessage * msg );
    State choice_____Debug__C__Initial__deephistory( const UMLRTMessage * msg );
    State choice_____Debug__Path__IDLE__IDLE__1( const UMLRTMessage * msg );
    State choice_____Debug__Path__Initial( const UMLRTMessage * msg );
    State state_____Debug__C__IDLE__IDLE__1__Debug__A__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    State state_____Debug__C__IDLE__IDLE__1__Debug__A__En__IDLE( const UMLRTMessage * msg );
    State state_____Debug__C__IDLE__IDLE__1__Debug__B__Ac__IDLE__IDLE__1( const UMLRTMessage * msg );
    State state_____Debug__C__IDLE__IDLE__1__Debug__B__Ex__IDLE( const UMLRTMessage * msg );
    State state_____Debug__C__IDLE__IDLE__1__boundary( const UMLRTMessage * msg );
