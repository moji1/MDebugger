...
SRCS = SimulatorMain.cc SystemConfig.cc ConfigProtocol.cc ENV.cc Server.cc Client.cc FailOver.cc HostInfo.cc Host.cc Services.cc ServerInfo.cc Echo.cc EchoCapsule.cc Simulator.cc SimulatorControllers.cc 
OBJS = $(subst $(CC_EXT),$(OBJ_EXT),$(SRCS))

MAIN = SimulatorMain$(EXE_EXT)
