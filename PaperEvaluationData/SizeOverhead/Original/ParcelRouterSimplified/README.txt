Name: Parcel Router without jam control
Author: Nicolas Hili <hili@cs.queensu.ca>
Version: 0.1
Last edited: February, 15, 2017
Papyrus-RT C++ Code Generator: 0.8.0.201612210512 Eclipse SDK: Neon.2 (4.6.2)
...
Description:
    ...
    appear.  This model *does not* support jam control so it does not prevent
    new parcel from being generated / transfered from one chute to another if
    jam occurs in the following chute.
