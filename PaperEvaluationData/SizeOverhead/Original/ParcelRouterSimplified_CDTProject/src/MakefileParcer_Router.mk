...
SRCS = Parcer_RouterMain.cc Parcel.cc transmission.cc Gen.cc Stage.cc Bin.cc Chute.cc Switcher.cc detection.cc Sensor.cc switchProtocol.cc Parcer_Router.cc Parcer_RouterControllers.cc 
OBJS = $(subst $(CC_EXT),$(OBJ_EXT),$(SRCS))

MAIN = Parcer_RouterMain$(EXE_EXT)
