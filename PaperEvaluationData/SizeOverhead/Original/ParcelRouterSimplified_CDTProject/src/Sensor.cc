...
void Capsule_Sensor::entryaction_____IDLE( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Sensor::IDLE entry  */
...
void Capsule_Sensor::exitaction_____IDLE( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Sensor::IDLE exit  */
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
    #undef umlrtparam_p
}
...
void Capsule_Sensor::transitionaction_____TransitionAction1( const UMLRTMessage * msg )
{
    #define umlrtparam_p ( *(const Parcel * )msg->getParam( 0 ) )
    #define rtdata ( (const Parcel * )msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Sensor transition IDLE,IDLE,detect:detection */
