...
void Capsule_Gen::entryaction_____GENERATING( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Gen::GENERATING entry  */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Gen::GENERATING exit  */
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Gen transition initial,GENERATING */
    srand(time(0));
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouterSimplified/model.uml RootElement::Gen transition GENERATING,GENERATING,timeout:timer */
    int random = rand() % 4;
    parcel = Parcel();
