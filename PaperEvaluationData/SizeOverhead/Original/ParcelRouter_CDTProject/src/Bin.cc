...
void Capsule_Bin::entryaction_____IDLE( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouter/model.uml RootElement::Bin::IDLE entry  */
...
void Capsule_Bin::exitaction_____IDLE( const UMLRTMessage * msg )
{
    ...
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouter/model.uml RootElement::Bin::IDLE exit  */
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
    #undef umlrtparam_p
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouter/model.uml RootElement::Bin transition initial,IDLE */
...
void Capsule_Bin::transitionaction_____TransitionAction1( const UMLRTMessage * msg )
{
    #define umlrtparam_p ( *(const Parcel * )msg->getParam( 0 ) )
    #define rtdata ( (const Parcel * )msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/ParcelRouter/model.uml RootElement::Bin transition IDLE,IDLE,transmit:enter */
