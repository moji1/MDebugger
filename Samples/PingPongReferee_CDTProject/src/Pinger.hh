...
private:
    ...
    void actionchain_____Debug__C__Initial__new_transition_37( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_38( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_39( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_40_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_41_to_visited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_42( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_43( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_44( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_45( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_46( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_47( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_48( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_49( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_50( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_51( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_52( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_53( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_54( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_55( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_56( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_57( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_58( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_59( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_60( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_61( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_62( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_63( const UMLRTMessage * msg );
    void actionchain_____Debug__C__Initial__new_transition_64( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__C__endOfRound__new_transition_100( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_101( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_102( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_103( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_104( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_105( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_106( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_107( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_108( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_109( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_110( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_111( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_112( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_113( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_114( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_115( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_116( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_117( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_118( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_119( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_120( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_121( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_122( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_123( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_95( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_96( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_97( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_98_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__endOfRound__new_transition_99_to_visited_boundary( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__C__startSignal__new_transition_1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_10( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_11( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_12( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_13( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_14( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_15( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_16( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_17( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_18( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_19( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_2( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_20( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_21( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_22( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_23( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_24( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_25( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_26( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_27( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_28( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_29( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_3( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_30( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_31( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_32( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_33( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_34( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_35( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_36( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_4( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_5_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_6_to_visited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_7( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_8( const UMLRTMessage * msg );
    void actionchain_____Debug__C__startSignal__new_transition_9( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__C__timeout__new_transition_153( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_154( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_155( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_156( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_157_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_158_to_visited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_159( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_160( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_161( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_162( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_163( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_164( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_165( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_166( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_167( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_168( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_169( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_170( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_171( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_172( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_173( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_174( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_175( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_176( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_177( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_178( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_179( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_180( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_181( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_182( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_183( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_184( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_185( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_186( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_187( const UMLRTMessage * msg );
    void actionchain_____Debug__C__timeout__new_transition_188( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__Initial__new_exitpoint_10( const UMLRTMessage * msg );
    State junction_____Debug__C__Initial__new_exitpoint_11( const UMLRTMessage * msg );
    State junction_____Debug__C__Initial__new_exitpoint_12( const UMLRTMessage * msg );
    State junction_____Debug__C__Initial__new_exitpoint_7( const UMLRTMessage * msg );
    State junction_____Debug__C__Initial__new_exitpoint_8( const UMLRTMessage * msg );
    State junction_____Debug__C__Initial__new_exitpoint_9( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__endOfRound__new_exitpoint_19( const UMLRTMessage * msg );
    State junction_____Debug__C__endOfRound__new_exitpoint_20( const UMLRTMessage * msg );
    State junction_____Debug__C__endOfRound__new_exitpoint_21( const UMLRTMessage * msg );
    State junction_____Debug__C__endOfRound__new_exitpoint_22( const UMLRTMessage * msg );
    State junction_____Debug__C__endOfRound__new_exitpoint_23( const UMLRTMessage * msg );
    State junction_____Debug__C__endOfRound__new_exitpoint_24( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__startSignal__new_exitpoint_1( const UMLRTMessage * msg );
    State junction_____Debug__C__startSignal__new_exitpoint_2( const UMLRTMessage * msg );
    State junction_____Debug__C__startSignal__new_exitpoint_3( const UMLRTMessage * msg );
    State junction_____Debug__C__startSignal__new_exitpoint_4( const UMLRTMessage * msg );
    State junction_____Debug__C__startSignal__new_exitpoint_5( const UMLRTMessage * msg );
    State junction_____Debug__C__startSignal__new_exitpoint_6( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__timeout__new_exitpoint_31( const UMLRTMessage * msg );
    State junction_____Debug__C__timeout__new_exitpoint_32( const UMLRTMessage * msg );
    State junction_____Debug__C__timeout__new_exitpoint_33( const UMLRTMessage * msg );
    State junction_____Debug__C__timeout__new_exitpoint_34( const UMLRTMessage * msg );
    State junction_____Debug__C__timeout__new_exitpoint_35( const UMLRTMessage * msg );
    State junction_____Debug__C__timeout__new_exitpoint_36( const UMLRTMessage * msg );
