...
private:
    ...
    void actionchain_____Debug__C__keepPlaying__new_transition_1( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_10( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_11( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_12( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_13( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_14( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_15( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_16( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_17( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_18( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_19( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_2( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_20( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_21( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_22( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_23( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_24( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_25( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_26( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_27( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_28( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_29( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_3( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_4_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_5_to_visited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_6( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_7( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_8( const UMLRTMessage * msg );
    void actionchain_____Debug__C__keepPlaying__new_transition_9( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__C__onPing__new_transition_59( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_60( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_61( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_62( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_63_to_unvisited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_64_to_visited_boundary( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_65( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_66( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_67( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_68( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_69( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_70( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_71( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_72( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_73( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_74( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_75( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_76( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_77( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_78( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_79( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_80( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_81( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_82( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_83( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_84( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_85( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_86( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_87( const UMLRTMessage * msg );
    ...
    void actionchain_____Debug__C__onPing__new_transition_92( const UMLRTMessage * msg );
    void actionchain_____Debug__C__onPing__new_transition_93( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__keepPlaying__new_exitpoint_1( const UMLRTMessage * msg );
    State junction_____Debug__C__keepPlaying__new_exitpoint_2( const UMLRTMessage * msg );
    State junction_____Debug__C__keepPlaying__new_exitpoint_3( const UMLRTMessage * msg );
    State junction_____Debug__C__keepPlaying__new_exitpoint_4( const UMLRTMessage * msg );
    State junction_____Debug__C__keepPlaying__new_exitpoint_5( const UMLRTMessage * msg );
    State junction_____Debug__C__keepPlaying__new_exitpoint_6( const UMLRTMessage * msg );
    ...
    State junction_____Debug__C__onPing__new_exitpoint_13( const UMLRTMessage * msg );
    State junction_____Debug__C__onPing__new_exitpoint_14( const UMLRTMessage * msg );
    State junction_____Debug__C__onPing__new_exitpoint_15( const UMLRTMessage * msg );
    State junction_____Debug__C__onPing__new_exitpoint_16( const UMLRTMessage * msg );
    State junction_____Debug__C__onPing__new_exitpoint_17( const UMLRTMessage * msg );
    State junction_____Debug__C__onPing__new_exitpoint_18( const UMLRTMessage * msg );
