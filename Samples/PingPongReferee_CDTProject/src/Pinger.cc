...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Pseudo2,Debug__InitState */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_12,Debug__C__Initial */
    msg->defer();
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_11,Debug__C__Initial */
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_9,Debug__C__Initial */
    char loc[1024];
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_8,Debug__C__Initial */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_7,Debug__C__Initial */
    char varName1[256];
    char varValue1[1024];
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__Initial::new_exitpoint_10,Debug__C__Initial */
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_24,Debug__C__endOfRound */
    msg->defer();
    std::cout<<"A message defered"<<"\n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_23,Debug__C__endOfRound */
    this->Debug__SRO.setExecMode((ExecMode)( *(int *)msg->getParam( 0 ) ));
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_21,Debug__C__endOfRound */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.remBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_20,Debug__C__endOfRound */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.addBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_19,Debug__C__endOfRound */
    char varName1[256];
    char varValue1[1024];
    sprintf(varName1,"%s",(*(const char * *)msg->getParam( 0 )));
    sprintf(varValue1,"%s",(*(const char * *)msg->getParam( 1 )));
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__endOfRound::new_exitpoint_22,Debug__C__endOfRound */
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_6,Debug__C__startSignal */
    msg->defer();
    std::cout<<"A message defered"<<"\n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_5,Debug__C__startSignal */
    this->Debug__SRO.setExecMode((ExecMode)( *(int *)msg->getParam( 0 ) ));
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_3,Debug__C__startSignal */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.remBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_2,Debug__C__startSignal */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.addBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_1,Debug__C__startSignal */
    char varName1[256];
    char varValue1[1024];
    sprintf(varName1,"%s",(*(const char * *)msg->getParam( 0 )));
    sprintf(varValue1,"%s",(*(const char * *)msg->getParam( 1 )));
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__startSignal::new_exitpoint_4,Debug__C__startSignal */
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_36,Debug__C__timeout */
    msg->defer();
    std::cout<<"A message defered"<<"\n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_35,Debug__C__timeout */
    this->Debug__SRO.setExecMode((ExecMode)( *(int *)msg->getParam( 0 ) ));
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_33,Debug__C__timeout */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.remBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_32,Debug__C__timeout */
    char loc[1024];
    sprintf(loc,"%s",(*(const char * *)msg->getParam( 0 )));
    this->Debug__SRO.addBreakPoint(loc,(BreakPointType)( *(int *)msg->getParam( 1 ) ),( *(int *)msg->getParam( 2 ) ));
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_31,Debug__C__timeout */
    char varName1[256];
    char varValue1[1024];
    sprintf(varName1,"%s",(*(const char * *)msg->getParam( 0 )));
    sprintf(varValue1,"%s",(*(const char * *)msg->getParam( 1 )));
...
{
    #define rtdata ( (void *)msg->getParam( 0 ) )
    /* UMLRTGEN-USERREGION-BEGIN platform:/resource/PingPongReferee/PingPongRef_debug.uml PingPong::Pinger transition Debug__C__timeout::new_exitpoint_34,Debug__C__timeout */
    std::cout<<this->Debug__SRO.serializeBreakPoint()<<"n";
    /* UMLRTGEN-USERREGION-END */
    #undef rtdata
}
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_37( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial__Debug__B__Ac__Initial );
    entryaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_38( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial__Debug__A__Ac__Initial );
    entryaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_39( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial__Debug__A__En__Initial );
    entryaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_40_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_41_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_42( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_43( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_44( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_45( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_46( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__B__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_47( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_48( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_49( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_50( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__B__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_51( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_52( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_53( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_54( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__B__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_55( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_56( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_57( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_58( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__B__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_59( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_60( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_61( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_62( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__B__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__B__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_63( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__Ac__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_64( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__Initial__Debug__A__En__Initial( msg );
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__Debug__A__En__Initial );
...
void Capsule_Pinger::actionchain_____Debug__C__Initial__new_transition_65( const UMLRTMessage * msg )
{
    update_state( Debug__C__Initial );
    save_history( Debug__C__Initial, Debug__C__Initial__boundary );
}
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_100( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_101( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_102( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_103( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_104( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__B__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_105( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_106( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_107( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_108( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__B__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_109( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_110( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_111( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_112( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__B__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_113( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_114( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_115( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_116( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__B__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_117( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_118( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_119( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_120( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__B__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_121( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_122( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__En__endOfRound );
...
void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_123( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound );
    save_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_95( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound__Debug__B__Ac__endOfRound );
    entryaction_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_96( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound__Debug__A__Ac__endOfRound );
    entryaction_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_97( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound__Debug__A__En__endOfRound );
    entryaction_____Debug__C__endOfRound__Debug__A__En__endOfRound( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_98_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__endOfRound__new_transition_99_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__endOfRound__boundary );
}
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_1( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
    entryaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_10( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_11( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_12( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_13( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_14( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_15( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_16( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_17( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_18( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_19( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_2( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__Debug__B__Ac__startSignal );
    entryaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_20( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_21( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_22( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_23( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_24( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_25( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_26( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_27( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_28( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_29( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_3( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__Debug__A__Ac__startSignal );
    entryaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_30( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_31( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_32( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_33( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_34( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_35( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_36( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_4( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__Debug__A__En__PLAYING );
    entryaction_____Debug__C__startSignal__Debug__A__En__PLAYING( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_5_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_6_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__startSignal__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_7( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_8( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__B__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__startSignal__new_transition_9( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__startSignal__Debug__A__Ac__startSignal( msg );
    update_state( Debug__C__startSignal );
    save_history( Debug__C__startSignal, Debug__C__startSignal__Debug__A__Ac__startSignal );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_153( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
    entryaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_154( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__Debug__B__Ac__timeout );
    entryaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_155( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__Debug__A__Ac__timeout );
    entryaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_156( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__Debug__A__En__PLAYING );
    entryaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_157_to_unvisited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_158_to_visited_boundary( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_159( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_160( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_161( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_162( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_163( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_164( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_165( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_166( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_167( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_168( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_169( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_170( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_171( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_172( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_173( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_174( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_175( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_176( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_177( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_178( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_179( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_180( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_181( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_182( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_183( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}

void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_184( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_185( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__B__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_186( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__Ac__timeout( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__Ac__timeout );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_187( const UMLRTMessage * msg )
{
    exitaction_____Debug__C__timeout__Debug__A__En__PLAYING( msg );
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__Debug__A__En__PLAYING );
...
void Capsule_Pinger::actionchain_____Debug__C__timeout__new_transition_188( const UMLRTMessage * msg )
{
    update_state( Debug__C__timeout );
    save_history( Debug__C__timeout, Debug__C__timeout__boundary );
}
...
Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_10( const UMLRTMessage * msg )
{
    actionchain_____Debug__Initial__dbg__viewBreakPoints( msg );
    return choice_____Debug__C__Initial__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_11( const UMLRTMessage * msg )
{
    actionchain_____Debug__Initial__dbg__dbgSetExecMode( msg );
    return choice_____Debug__C__Initial__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_12( const UMLRTMessage * msg )
{
    actionchain_____Debug__Initial__dbg__dbgDeferMsg( msg );
    return choice_____Debug__C__Initial__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_7( const UMLRTMessage * msg )
{
    actionchain_____Debug__Initial__dbg__varChange( msg );
    return choice_____Debug__C__Initial__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_8( const UMLRTMessage * msg )
{
    actionchain_____Debug__Initial__dbg__setBreakPoint( msg );
    return choice_____Debug__C__Initial__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__Initial__new_exitpoint_9( const UMLRTMessage * msg )
{
...
Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_19( const UMLRTMessage * msg )
{
    actionchain_____Debug__endOfRound__dbg__varChange( msg );
    return choice_____Debug__C__endOfRound__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_20( const UMLRTMessage * msg )
{
    actionchain_____Debug__endOfRound__dbg__setBreakPoint( msg );
    return choice_____Debug__C__endOfRound__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_21( const UMLRTMessage * msg )
{
    actionchain_____Debug__endOfRound__dbg__remBreakPoint( msg );
    return choice_____Debug__C__endOfRound__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_22( const UMLRTMessage * msg )
{
    actionchain_____Debug__endOfRound__dbg__viewBreakPoints( msg );
    return choice_____Debug__C__endOfRound__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_23( const UMLRTMessage * msg )
{
    actionchain_____Debug__endOfRound__dbg__dbgSetExecMode( msg );
    return choice_____Debug__C__endOfRound__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__endOfRound__new_exitpoint_24( const UMLRTMessage * msg )
{
...
Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_1( const UMLRTMessage * msg )
{
    actionchain_____Debug__startSignal__dbg__varChange( msg );
    return choice_____Debug__C__startSignal__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_2( const UMLRTMessage * msg )
{
    actionchain_____Debug__startSignal__dbg__setBreakPoint( msg );
    return choice_____Debug__C__startSignal__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_3( const UMLRTMessage * msg )
{
    actionchain_____Debug__startSignal__dbg__remBreakPoint( msg );
    return choice_____Debug__C__startSignal__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_4( const UMLRTMessage * msg )
{
    actionchain_____Debug__startSignal__dbg__viewBreakPoints( msg );
    return choice_____Debug__C__startSignal__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_5( const UMLRTMessage * msg )
{
    actionchain_____Debug__startSignal__dbg__dbgSetExecMode( msg );
    return choice_____Debug__C__startSignal__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__startSignal__new_exitpoint_6( const UMLRTMessage * msg )
{
...
Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_31( const UMLRTMessage * msg )
{
    actionchain_____Debug__timeout__dbg__varChange( msg );
    return choice_____Debug__C__timeout__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_32( const UMLRTMessage * msg )
{
    actionchain_____Debug__timeout__dbg__setBreakPoint( msg );
    return choice_____Debug__C__timeout__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_33( const UMLRTMessage * msg )
{
    actionchain_____Debug__timeout__dbg__remBreakPoint( msg );
    return choice_____Debug__C__timeout__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_34( const UMLRTMessage * msg )
{
    actionchain_____Debug__timeout__dbg__viewBreakPoints( msg );
    return choice_____Debug__C__timeout__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_35( const UMLRTMessage * msg )
{
    actionchain_____Debug__timeout__dbg__dbgSetExecMode( msg );
    return choice_____Debug__C__timeout__deephistory( msg );
}

Capsule_Pinger::State Capsule_Pinger::junction_____Debug__C__timeout__new_exitpoint_36( const UMLRTMessage * msg )
{
...
Capsule_Pinger::State Capsule_Pinger::choice_____Debug__C__Initial__deephistory( const UMLRTMessage * msg )
{
    ...
    {
        actionchain_____Debug__C__Initial__new_transition_37( msg );
        return Debug__C__Initial__Debug__B__Ac__Initial;
    }
    else if( check_history( Debug__C__Initial, Debug__C__Initial__Debug__A__Ac__Initial ) )
    {
        actionchain_____Debug__C__Initial__new_transition_38( msg );
...
Capsule_Pinger::State Capsule_Pinger::choice_____Debug__C__endOfRound__deephistory( const UMLRTMessage * msg )
{
    ...
    {
        actionchain_____Debug__C__endOfRound__new_transition_95( msg );
        return Debug__C__endOfRound__Debug__B__Ac__endOfRound;
    }
    else if( check_history( Debug__C__endOfRound, Debug__C__endOfRound__Debug__A__Ac__endOfRound ) )
    {
        actionchain_____Debug__C__endOfRound__new_transition_96( msg );
    ...
    {
        actionchain_____Debug__C__endOfRound__new_transition_97( msg );
    ...
    {
        actionchain_____Debug__C__endOfRound__new_transition_98_to_unvisited_boundary( msg );
        return Debug__C__endOfRound__boundary;
    }
    else if( check_history( Debug__C__endOfRound, Debug__C__endOfRound__boundary ) )
    {
        actionchain_____Debug__C__endOfRound__new_transition_99_to_visited_boundary( msg );
        return Debug__C__endOfRound__boundary;
    }
    return currentState;
}
...
Capsule_Pinger::State Capsule_Pinger::choice_____Debug__C__startSignal__deephistory( const UMLRTMessage * msg )
{
    ...
    {
        actionchain_____Debug__C__startSignal__new_transition_1( msg );
        return Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START;
    }
    else if( check_history( Debug__C__startSignal, Debug__C__startSignal__Debug__B__Ac__startSignal ) )
    {
        actionchain_____Debug__C__startSignal__new_transition_2( msg );
    ...
    {
        actionchain_____Debug__C__startSignal__new_transition_3( msg );
    ...
    {
        actionchain_____Debug__C__startSignal__new_transition_4( msg );
    ...
    {
        actionchain_____Debug__C__startSignal__new_transition_5_to_unvisited_boundary( msg );
        return Debug__C__startSignal__boundary;
    }
    else if( check_history( Debug__C__startSignal, Debug__C__startSignal__boundary ) )
    {
        actionchain_____Debug__C__startSignal__new_transition_6_to_visited_boundary( msg );
        return Debug__C__startSignal__boundary;
    }
    return currentState;
}
...
Capsule_Pinger::State Capsule_Pinger::choice_____Debug__C__timeout__deephistory( const UMLRTMessage * msg )
{
    ...
    {
        actionchain_____Debug__C__timeout__new_transition_153( msg );
        return Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER;
    }
    else if( check_history( Debug__C__timeout, Debug__C__timeout__Debug__B__Ac__timeout ) )
    {
        actionchain_____Debug__C__timeout__new_transition_154( msg );
    ...
    {
        actionchain_____Debug__C__timeout__new_transition_155( msg );
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__Initial__Debug__A__Ac__Initial( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__Initial__new_transition_43( msg );
            return junction_____Debug__C__Initial__new_exitpoint_7( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_47( msg );
            return junction_____Debug__C__Initial__new_exitpoint_8( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_51( msg );
            return junction_____Debug__C__Initial__new_exitpoint_9( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__Initial__new_transition_55( msg );
            return junction_____Debug__C__Initial__new_exitpoint_10( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__Initial__new_transition_59( msg );
            return junction_____Debug__C__Initial__new_exitpoint_11( msg );
        default:
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__Initial__new_transition_63( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
            actionchain_____Debug__C__Initial__new_transition_63( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
        }
        return currentState;
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__Initial__Debug__A__En__Initial( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__Initial__new_transition_44( msg );
            return junction_____Debug__C__Initial__new_exitpoint_7( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_48( msg );
            return junction_____Debug__C__Initial__new_exitpoint_8( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_52( msg );
            return junction_____Debug__C__Initial__new_exitpoint_9( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__Initial__new_transition_56( msg );
            return junction_____Debug__C__Initial__new_exitpoint_10( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__Initial__new_transition_60( msg );
            return junction_____Debug__C__Initial__new_exitpoint_11( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__Initial__new_transition_64( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
            actionchain_____Debug__C__Initial__new_transition_64( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__Initial__Debug__B__Ac__Initial( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__Initial__Debug__A__Ac__Initial;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__Initial__new_transition_42( msg );
            return junction_____Debug__C__Initial__new_exitpoint_7( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_46( msg );
            return junction_____Debug__C__Initial__new_exitpoint_8( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_50( msg );
            return junction_____Debug__C__Initial__new_exitpoint_9( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__Initial__new_transition_54( msg );
            return junction_____Debug__C__Initial__new_exitpoint_10( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__Initial__new_transition_58( msg );
            return junction_____Debug__C__Initial__new_exitpoint_11( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__Initial__new_transition_62( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
            actionchain_____Debug__C__Initial__new_transition_62( msg );
            return junction_____Debug__C__Initial__new_exitpoint_12( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__Initial__boundary( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        {
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__Initial__new_transition_45( msg );
            return junction_____Debug__C__Initial__new_exitpoint_7( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_49( msg );
            return junction_____Debug__C__Initial__new_exitpoint_8( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__Initial__new_transition_53( msg );
            return junction_____Debug__C__Initial__new_exitpoint_9( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__Initial__new_transition_57( msg );
            return junction_____Debug__C__Initial__new_exitpoint_10( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__Initial__new_transition_61( msg );
            return junction_____Debug__C__Initial__new_exitpoint_11( msg );
        default:
            this->unexpectedMessage();
            break;
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__endOfRound__Debug__A__Ac__endOfRound( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__endOfRound__Debug__A__En__endOfRound;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__endOfRound__new_transition_101( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_19( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_105( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_20( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_109( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_21( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__endOfRound__new_transition_113( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_22( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__endOfRound__new_transition_117( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_23( msg );
        default:
            this->unexpectedMessage();
            break;
        }
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__endOfRound__new_transition_121( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
            actionchain_____Debug__C__endOfRound__new_transition_121( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
        }
        return currentState;
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__endOfRound__Debug__A__En__endOfRound( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__endOfRound__new_transition_102( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_19( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_106( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_20( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_110( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_21( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__endOfRound__new_transition_114( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_22( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__endOfRound__new_transition_118( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_23( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__endOfRound__new_transition_122( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
            actionchain_____Debug__C__endOfRound__new_transition_122( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__endOfRound__Debug__B__Ac__endOfRound( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__endOfRound__Debug__A__Ac__endOfRound;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__endOfRound__new_transition_100( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_19( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_104( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_20( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_108( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_21( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__endOfRound__new_transition_112( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_22( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__endOfRound__new_transition_116( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_23( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__endOfRound__new_transition_120( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
            actionchain_____Debug__C__endOfRound__new_transition_120( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__endOfRound__boundary( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        {
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__endOfRound__new_transition_103( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_19( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_107( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_20( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__endOfRound__new_transition_111( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_21( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__endOfRound__new_transition_115( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_22( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__endOfRound__new_transition_119( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_23( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__endOfRound__new_transition_123( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
            actionchain_____Debug__C__endOfRound__new_transition_123( msg );
            return junction_____Debug__C__endOfRound__new_exitpoint_24( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__startSignal__Debug__A__Ac__startSignal( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__startSignal__Debug__A__En__PLAYING;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__startSignal__new_transition_9( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_1( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_14( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_2( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_19( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_3( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__startSignal__new_transition_24( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_4( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__startSignal__new_transition_29( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_5( msg );
        default:
            this->unexpectedMessage();
            break;
        }
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__startSignal__new_transition_34( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
            actionchain_____Debug__C__startSignal__new_transition_34( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
        }
        return currentState;
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__startSignal__Debug__A__En__PLAYING( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__startSignal__new_transition_10( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_1( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_15( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_2( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_20( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_3( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__startSignal__new_transition_25( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_4( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__startSignal__new_transition_30( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_5( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__startSignal__new_transition_35( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
            actionchain_____Debug__C__startSignal__new_transition_35( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__startSignal__Debug__B__Ac__startSignal( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__startSignal__Debug__A__Ac__startSignal;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__startSignal__new_transition_8( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_1( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_13( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_2( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_18( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_3( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__startSignal__new_transition_23( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_4( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__startSignal__new_transition_28( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_5( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__startSignal__new_transition_33( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
            actionchain_____Debug__C__startSignal__new_transition_33( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__startSignal__Debug__B__Ex__WAITING_TO_START( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__startSignal__Debug__B__Ac__startSignal;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__startSignal__new_transition_7( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_1( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_12( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_2( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_17( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_3( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__startSignal__new_transition_22( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_4( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__startSignal__new_transition_27( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_5( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__startSignal__new_transition_32( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
            actionchain_____Debug__C__startSignal__new_transition_32( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__startSignal__boundary( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        {
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__startSignal__new_transition_11( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_1( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_16( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_2( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__startSignal__new_transition_21( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_3( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__startSignal__new_transition_26( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_4( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__startSignal__new_transition_31( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_5( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__startSignal__new_transition_36( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
            actionchain_____Debug__C__startSignal__new_transition_36( msg );
            return junction_____Debug__C__startSignal__new_exitpoint_6( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__timeout__Debug__A__Ac__timeout( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__timeout__Debug__A__En__PLAYING;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__timeout__new_transition_161( msg );
            return junction_____Debug__C__timeout__new_exitpoint_31( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_166( msg );
            return junction_____Debug__C__timeout__new_exitpoint_32( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_171( msg );
            return junction_____Debug__C__timeout__new_exitpoint_33( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__timeout__new_transition_176( msg );
            return junction_____Debug__C__timeout__new_exitpoint_34( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__timeout__new_transition_181( msg );
            return junction_____Debug__C__timeout__new_exitpoint_35( msg );
        default:
            this->unexpectedMessage();
            break;
        }
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__timeout__new_transition_186( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
            actionchain_____Debug__C__timeout__new_transition_186( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
        }
        return currentState;
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__timeout__Debug__A__En__PLAYING( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__timeout__new_transition_162( msg );
            return junction_____Debug__C__timeout__new_exitpoint_31( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_167( msg );
            return junction_____Debug__C__timeout__new_exitpoint_32( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_172( msg );
            return junction_____Debug__C__timeout__new_exitpoint_33( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__timeout__new_transition_177( msg );
            return junction_____Debug__C__timeout__new_exitpoint_34( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__timeout__new_transition_182( msg );
            return junction_____Debug__C__timeout__new_exitpoint_35( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__timeout__new_transition_187( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
            actionchain_____Debug__C__timeout__new_transition_187( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__timeout__Debug__B__Ac__timeout( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__timeout__Debug__A__Ac__timeout;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__timeout__new_transition_160( msg );
            return junction_____Debug__C__timeout__new_exitpoint_31( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_165( msg );
            return junction_____Debug__C__timeout__new_exitpoint_32( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_170( msg );
            return junction_____Debug__C__timeout__new_exitpoint_33( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__timeout__new_transition_175( msg );
            return junction_____Debug__C__timeout__new_exitpoint_34( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__timeout__new_transition_180( msg );
            return junction_____Debug__C__timeout__new_exitpoint_35( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__timeout__new_transition_185( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
            actionchain_____Debug__C__timeout__new_transition_185( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__timeout__Debug__B__Ex__WAITING_FOR_TIMER( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        case ExtInterface::signal_dbgExec:
            ...
            return Debug__C__timeout__Debug__B__Ac__timeout;
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__timeout__new_transition_159( msg );
            return junction_____Debug__C__timeout__new_exitpoint_31( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_164( msg );
            return junction_____Debug__C__timeout__new_exitpoint_32( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_169( msg );
            return junction_____Debug__C__timeout__new_exitpoint_33( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__timeout__new_transition_174( msg );
            return junction_____Debug__C__timeout__new_exitpoint_34( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__timeout__new_transition_179( msg );
            return junction_____Debug__C__timeout__new_exitpoint_35( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__timeout__new_transition_184( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
            actionchain_____Debug__C__timeout__new_transition_184( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
        }
...
Capsule_Pinger::State Capsule_Pinger::state_____Debug__C__timeout__boundary( const UMLRTMessage * msg )
{
    ...
    case port_extComm:
        ...
        {
        case ExtInterface::signal_dbgVarChange:
            actionchain_____Debug__C__timeout__new_transition_163( msg );
            return junction_____Debug__C__timeout__new_exitpoint_31( msg );
        case ExtInterface::signal_dbgSetBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_168( msg );
            return junction_____Debug__C__timeout__new_exitpoint_32( msg );
        case ExtInterface::signal_dbgRemBreakPoint:
            actionchain_____Debug__C__timeout__new_transition_173( msg );
            return junction_____Debug__C__timeout__new_exitpoint_33( msg );
        case ExtInterface::signal_dbgViewBreakPoints:
            actionchain_____Debug__C__timeout__new_transition_178( msg );
            return junction_____Debug__C__timeout__new_exitpoint_34( msg );
        case ExtInterface::signal_dbgSetExecMode:
            actionchain_____Debug__C__timeout__new_transition_183( msg );
            return junction_____Debug__C__timeout__new_exitpoint_35( msg );
        default:
            this->unexpectedMessage();
            break;
    ...
    case port_pingPort:
        ...
        {
        default:
            actionchain_____Debug__C__timeout__new_transition_188( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
            actionchain_____Debug__C__timeout__new_transition_188( msg );
            return junction_____Debug__C__timeout__new_exitpoint_36( msg );
        }
